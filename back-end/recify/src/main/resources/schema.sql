...
(
    ...
    INDEX `fk_playlist_has_music_music1_idx`
(
    `music_id`
    ASC
) VISIBLE,
    INDEX `fk_playlist_has_music_playlist1_idx`
(
    `playlist_id`
    ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_view_manager_music1_idx`
(
    `music_id`
    ASC
) VISIBLE,
    INDEX `fk_view_manager_user1_idx`
(
    `user_id`
    ASC
) VISIBLE,
